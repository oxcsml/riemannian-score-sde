...
from score_sde.utils.vis2 import earth_plot
...
def run(cfg):
    ...
    def generate_plots(train_state, stage, step=None):
        ...
        # # TODO: have an if statement
        # try:
        # # if isinstance(dataset, SphericalDataset):  # earth science dataset
        plt = earth_plot(log_prob, dataset, N=200)
