...
def main(cfg):
    ...
    out, _ = score_model.apply(params, state, next_rng, x=x, t=t, div='divE', hutchinson_type='None')
    ...
    for div in ['divE', 'div_split']:
        try:
            ...
            def body(step, val):
                rng, divs = val
                rng, next_rng = jax.random.split(rng)
                out, _ = score_model.apply(params, state, next_rng, x=x, t=t, div=div, hutchinson_type='Rademacher')
    ...
    div = lambda x, t, hutchinson_type: score_model.apply(params, state, next_rng, x=x, t=t, div='divE', hutchinson_type=hutchinson_type)[0]
