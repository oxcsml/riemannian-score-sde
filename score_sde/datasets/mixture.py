...
class vMFMixture:
    def __init__(
        self, batch_dims, rng, manifold, mu, kappa, weights=[0.5, 0.5]
    ):
    ...
    def __next__(self):
        ...
        random_von_mises_fisher = jax.vmap(partial(self.manifold.random_von_mises_fisher, n_samples=np.prod(self.batch_dims)))
